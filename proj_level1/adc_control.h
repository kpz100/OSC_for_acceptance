...
#define MIN_FFT_SAMPLE_FREQ 1000000.0f
#define WARNNING_FFT_FREQ 800000.0f
#define MAX_OVER_SAMPLE_FREQ 60000.0f
#define OVER_SAMPLE_RATE 60.0f
#define ETS_SAMPLE_RATE 120.0f

#define MAX_FFT_AMP_ERROR 0.05f
#define SAMPLE_FREQ_SHIFT 5000u
#define SHIFT_MAX_RANK ((uint32_t)(ORIGINAL_SAMPLE_FREQ - MIN_FFT_SAMPLE_FREQ) / SAMPLE_FREQ_SHIFT)
