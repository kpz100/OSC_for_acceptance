...
LR_IROM1 0x08000000 0x00200000  {    ; load region size_region
  ...
  RW_MPU_REGION_1 0x24000000 UNINIT 0x00010000 {    ; 64kb
    *(.bss.MPU_REGION_1)
  }
  RW_IRAM2_POST 0x24010000 0x00070000 {
   .ANY (+RW +ZI)
  }
  RW_MPU_REGION_2 0x30000000 UNINIT 0x00004000  {    ; 16kb
    *(.bss.MPU_REGION_2)  
  }
  RW_SRAM123_REMAIN 0x30004000 0x00044000  {
    .ANY (+RW +ZI)
  }
  RW_SRAM4_REMAIN 0x38000000 0x00010000 {
    .ANY (+RW +ZI)
  }
  RW_LCD_FRAME_BUFFER 0xC0000000 UNINIT 0x00177000  {    ;total 32mb
