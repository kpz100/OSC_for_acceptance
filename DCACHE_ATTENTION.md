...
LR_IROM1 0x08000000 0x00200000  {    ; load region size_region
  ...
  RW_IRAM2_POST 0x24008000 0x00078000  {
   .ANY (+RW +ZI)
  }


  RW_MPU_REGION_1 0x24004000 UNINIT 0x00004000  {
    *(.bss.MPU_REGION_1)
  }
  RW_MPU_REGION_2 0x30000000 UNINIT 0x00004000  {
    *(.bss.MPU_REGION_2)
  }
  RW_LCD_FRAME_BUFFER 0xC0000000 UNINIT 0x00177000  {
