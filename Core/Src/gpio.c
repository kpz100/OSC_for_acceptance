...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TOUCH_SCLK_GPIO_Port, TOUCH_SCLK_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : TOUCH_SCLK_Pin */
  GPIO_InitStruct.Pin = TOUCH_SCLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TOUCH_SCLK_GPIO_Port, &GPIO_InitStruct);
